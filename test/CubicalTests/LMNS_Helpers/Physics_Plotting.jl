...
function plot_vorticity(s, U::AbstractVector, file_end::String, time::String)
  ...
  fig = Figure()
  ax = Axis(fig[1, 1], title = "Vorticity Field (ω) at $(time)")
...
function plot_density(s, rho::AbstractVector, file_end::String, time::String)
  fig = Figure()
  ax = Axis(fig[1, 1], title = "Density Field (ρ) at $(time)")
...
function plot_velocity_magnitude(s, U::AbstractVector, file_end::String, time::String)
  ...
  fig = Figure()
  ax = Axis(fig[1, 1], title = "Velocity Magnitude at $(time)")
...
function plot_velocity_components(s, U::AbstractVector, file_end::String, time::String)
  ...
  Y = interior(Val(2), Y, s)
  fig = Figure()
  axX = Axis(fig[1,1]; title = "X Component at $(time)", xlabel = "x", ylabel = "y")
  hmX = heatmap!(axX, xs, ys, X, colormap=:jet)
  Colorbar(fig[1, 2], hmX)

  axY = Axis(fig[2,1]; title = "Y Component at $(time)", xlabel = "x", ylabel = "y")
...
function plot_pressure(s, Theta::AbstractVector, file_end::String, time::String)
  ...
  fig = Figure()
  ax = Axis(fig[1, 1], title = "Pressure Field (p) at $(time)")
...
function create_mp4(Us, rhos, file_end::String; frames::Int = length(Us), framerate::Int = 15, records::Int = 50)
    ...
    ax3 = Axis(fig[2, 1], title = "Density Field (ρ)")
...
function create_mp4(Us, rhos, Thetas, file_end::String; frames::Int = length(Us), framerate::Int = 15, records::Int = 50)
    ...
    fig = Figure()
    ax1 = Axis(fig[1, 1], title = "Velocity Field (u)")
    ax2 = Axis(fig[1, 2], title = "Velocity Field (v)")
    ax3 = Axis(fig[2, 1], title = "Density Field (ρ)")
    # ax4 = Axis(fig[2, 2], title = "Velocity Magnitude")
    ax4 = Axis(fig[2, 2], title = "Dc Potential Temperature (Θ)")
    ax5 = Axis(fig[1, 3], title = "Potential Temperature (Θ)")
    # ax6 = Axis(fig[2, 3], title = "Vorticity Field (ω)")
    ax6 = Axis(fig[2, 3], title = "Pressure Field (p)")
