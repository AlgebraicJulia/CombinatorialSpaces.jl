...
abstract type HasCubicalComplex2D <: HasCubicalComplex end
...
struct EmbeddedCubicalComplex2D <: HasCubicalComplex2D
  nx::Int
  ny::Int
...
dual_mesh(s::EmbeddedCubicalComplex2D) = EmbeddedCubicalComplex2D(nx(s) - 1, ny(s) - 1, map(c -> dual_point(s, c...), quadrilaterals(s)))
