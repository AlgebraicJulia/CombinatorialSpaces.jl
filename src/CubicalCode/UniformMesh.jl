...
is_edge_X_aligned(e::Int, s::AbstractCubicalComplex2D) = e <= nxedges(s)
is_edge_Y_aligned(e::Int, s::AbstractCubicalComplex2D) = e > nxedges(s)
...
edge_len(s::UniformCubicalComplex2D, e::Int) = edge_len(s, edge_to_coord(s, e)...)
...
dual_points(s::UniformCubicalComplex2D) = map(v -> dual_point(s, quad_to_coord(s, v)...), quads(s))

real_dual_point(s::UniformCubicalComplex2D, x::Int, y::Int) = dual_point(s, x + halo_west(s), y + halo_south(s))
...
dual_edge_len(s::AbstractCubicalComplex2D, e::Int) = dual_edge_len(s, edge_to_coord(s, e)...)
...
dual_quad_area(s::UniformCubicalComplex2D, v::Int) = begin
  x, y = vert_to_coord(s, v)
