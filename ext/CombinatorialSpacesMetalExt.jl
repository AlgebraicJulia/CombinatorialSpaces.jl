...
Compute an inverse Hodge star as a Metal array (diagonal Hodge) or a sparse direct solver
function (geometric Hodge, primal 1-forms on 2D meshes). Metal only supports Float32 meshes.
"""
dec_inv_hodge_star(n::Int, sd::HasDeltaSet, h::DiscreteHodge, ::Val{:Metal}) =
